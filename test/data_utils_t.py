...
def preprocess_phoneme_data_t(input_filepath):
    ...
    feature_ordering, objects_np, symbol_to_fl, fv_to_symbols = data_utils.preprocess_phoneme_data(input_filepath, output_filepath, features_list_filepath, columns_to_remove)
